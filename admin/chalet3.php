...
<html>
 ...
 <body>
  ...
  <div class="container" style="margin-left: -12.5%;>
      <br />
      <div align="left">
  <?php include 'add/modal_junior.php';?>
</div>
     <div class="panel panel-default" style="width: 100%; margin-left: -10%;">
     <div class="panel-heading" style="background-color: grey; color: rgb(255, 215, 32);">CHALET 3 DETAILS</div>
       ...
       <div class="table-responsive" id="user_data">
        <table class="table table-bordered table-striped">
           <tr style="background-color: grey; color: rgb(255, 215, 32);">
            ...
            <?php 
              $query = "SELECT * FROM cottage3 ORDER BY num";
              $result = mysqli_query($mysqli, $query);
              while ($row = mysqli_fetch_array($result)) : ?>
                <tr>
                    <form method="post" action="junior_sql.php">
                      <?php if (!empty($row[1])) : ?>
