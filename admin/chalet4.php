...
<html>
 ...
 <body>
  ...
  <div class="container">
      <br />
       <div align="left" style="margin-left: -24.7%;>
  <?php include 'add/modal_suite.php';?>
</div>
     <div class="panel panel-default" style="width: 100%; margin-left: -12%;">
     <div class="panel-heading" style="background-color: grey; color: rgb(255, 215, 32);">CHALET 4 DETAILS</div>
       ...
       <div class="table-responsive" id="user_data" >
        <table class="table table-bordered table-striped">
           <tr style="background-color: grey; color: rgb(255, 215, 32);">
            ...
            <?php 
              $query = "SELECT * FROM cottage4 ORDER BY num";
              $result = mysqli_query($mysqli, $query);
              while ($row = mysqli_fetch_array($result)) : ?>
                <tr>
                    <form method="post" action="suite_sql.php">
                      <?php if (!empty($row[1])) : ?>
