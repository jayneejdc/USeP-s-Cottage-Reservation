	...
	<nav id="header" class="navbar navbar-fixed-top">
		<div class="container">
		   	<ul class="nav nav-header navbar-nav navbar-left masthead-nav"  font-size: 20px;">
		        <li><a href="cottages/cottage1.php" style="color: rgb(218,165,32);">Bookings</a></li>
		        <li><a href="index.php#pic1" style="color: rgb(218,165,32);">Ammenities</a></li>
	            ...
	            <li><a href="gallery.php" style="color: rgb(218,165,32);">Gallery</a></li>
	        </ul>
		</div>
	</nav>
</header>
