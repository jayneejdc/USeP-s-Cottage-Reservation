...
<html>
<head>
	<title>Chalet 1</title>
	<link rel="stylesheet" type="text/css" href="../css/rooms.css">
</head>

<body>
	<div class="cottage" style="color: white; background-color: rgba(40,40,40,1); margin-left: 19%; padding: 1%;">
		<h3 style=" margin-left: 5%; margin-top: 5%;"><center>Cottage 1</center></h3>
		<img src="../Images/30.jpg" style="width: 90%; margin-left: 2%; border: 3px solid white;">
		<div class="rText" style="margin-top: 3%;">
			<h4>P500.00 / day</h4>
			<p style="text-align: justify;">Its architectural principles gave way to many of Filipino traditional houses and buildings that rose after the pre-colonial era.Nipa huts were the native houses of the indigenous people of the Philippines before the Spaniards arrived.</p>		
			<br><br>	
		</div>
	</div>
