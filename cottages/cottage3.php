...
<html>
<head>
	<title>Chalet 3</title>
	<link rel="stylesheet" type="text/css" href="../css/rooms.css">
</head>

<body>
	<div class="cottage" style="color: white; background-color: rgba(40,40,40,1); margin-left: 19%; padding: 1%;">
		<h3 style=" margin-left: 5%; margin-top: 5%; color: white;"><center>Cottage 3</center></h3>
		<img src="../Images/12.jpg" style="width: 90%; margin-left: 2%;">
		<div class="rText" style="margin-top: 3%;">
			<h4>P1,500.00 / day</h4>
			<p style="text-align: justify;">They were designed to endure the climate and environment of the Philippines. These structures were temporary, made from plant materials like bamboo.</p>		
			<br><br>	
		</div>
	</div>
